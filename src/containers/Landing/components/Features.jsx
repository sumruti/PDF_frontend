        ...
        <Col md={12}>
          <div className="landing__features-wrap">
            <div className="landing__feature">
              ...
              <p className="landing__feature-title">Tenant Communication AI</p>
            ...
            <div className="landing__feature">
              ...
              <p className="landing__feature-title">Manage Your Properties</p>
            ...
            <div className="landing__feature">
              ...
              <p className="landing__feature-title">Accounting</p>
